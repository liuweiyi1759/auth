...
public class TestOcrV3 {
	...
	public static void send(){
		try{
			...
			String img = "data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wBDAAgFBgcGBQgHBgcJCAgJDBMMDAsLDBgREg4THB";
			String appCode = "mtpm-appservice";
			//http://10.10.128.32:8558/public-gateway/ocr/v3/ocr/base64?appid=
			HttpPost httpPost = new HttpPost("http://10.10.129.33:8099/ocr/v3/ocr/base64?appid=" + appid + "&random=" + random);
